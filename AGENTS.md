...
- `.claude/skills/`: generated byte-identical copies of `.agents/skills/*/SKILL.md` for
  Claude Code discovery. Edit the source and run `make sync-skills`; never edit the copies.
