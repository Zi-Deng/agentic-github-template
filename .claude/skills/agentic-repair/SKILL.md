---
name: agentic-repair
description: "Read GitHub PR reviews and inline comments, resume the original pinned implementer session, and publish evidence-backed repairs or dispositions. Use for the repair phase after review; do not replace the original executor or blindly apply unsupported findings."
---
